...
// non-empty tag that will maintain whitespace around them
...
// non-empty tag that will maintain whitespace within them
...
// self-closing tag that will maintain whitespace around them
...
// - retain all tag which are adjacent to non-standard HTML tag
...
function minify(value, options, partialMarkup) {
  ...
  // look for trailing whitespaces, bypass any inline tag
  ...
  new HTMLParser(value, {
    ...
    start: function(tag, attrs, unary, unarySlash, autoGenerated) {
      ...
      // set whitespace flags for nested tag (eg. <code> within a <pre>)
      if (options.collapseWhitespace) {
      ...
      if (options.removeOptionalTags) {
        ...
        // except for </dt> or </thead>, end tag may be omitted if no more content in parent element
