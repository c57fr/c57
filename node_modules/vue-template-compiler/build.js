...
// HTML5 tag https://html.spec.whatwg.org/multipage/indices.html#elements-3
...
// Regular Expressions for parsing tag and attributes
    ...
    start: function start (tag, attrs, unary) {
      ...
      if (isForbiddenTag(element) && !isServerRendering()) {
        ...
        process.env.NODE_ENV !== 'production' && warn$1(
          ...
          'UI. Avoid placing tag with side-effects in your templates, such as ' +
